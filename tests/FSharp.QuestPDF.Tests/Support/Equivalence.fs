...
[<AutoOpen>]
module FSharp.QuestPDF.Tests.Support.Equivalence
...
let private artifactsDirectory () =
    Environment.GetEnvironmentVariable "FSHARP_QUESTPDF_TEST_ARTIFACTS"
    |> Option.ofObj
...
/// page images to $FSHARP_QUESTPDF_TEST_ARTIFACTS when that variable is set.

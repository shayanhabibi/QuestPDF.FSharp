...
module FSharp.QuestPDF.Preview.Tests.SageFsEndToEndTests
    ...
    <| testList
        ...
        [ e2e "a saved script reloads through the daemon: an edit, a compile error, its fix and an edit of a loaded file" (fun () ->
              ...
              try
                  ...
                  for name in [ "FSharp.QuestPDF.dll"; "FSharp.QuestPDF.Preview.dll" ] do
                  ...
                  rewrite script "\"../../src/FSharp.QuestPDF.Preview/bin/Release/net10.0/" $"\"{libPath}/"
          ...
          e2e "a saved project file patches the document function of a Hot Reload session" (fun () ->
              ...
              try
                  ...
                  rewrite project "..\\..\\src\\FSharp.QuestPDF\\" $"{src}/FSharp.QuestPDF/"
                  rewrite project "..\\..\\src\\FSharp.QuestPDF.Preview\\" $"{src}/FSharp.QuestPDF.Preview/"

...
module Preview =
    ...
    type Diagnostic =
        {
            /// <summary>The full path of the file that holds the error: the reloaded script or a file it loads.</summary>
            File: string
    ...
    type Server =
        ...
        member internal Snapshot: FSharp.QuestPDF.PreviewServer.Snapshot
        /// The number of open event streams.
        member internal Clients: int
        /// The render loop and routes of the server.
        member internal Engine: FSharp.QuestPDF.PreviewServer.Engine
    ...
    val internal start:
        env: FSharp.QuestPDF.PreviewServer.ServeEnv ->
        options: Options ->
        reload: string ->
    ...
    val internal serveWith:
        env: FSharp.QuestPDF.PreviewServer.ServeEnv -> options: Options -> document: (unit -> #IDocument) -> Server
